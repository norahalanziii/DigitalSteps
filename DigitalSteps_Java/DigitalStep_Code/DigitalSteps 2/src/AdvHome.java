 ...
 * @author Miad2
 */
public class AdvHome extends javax.swing.JFrame {

    /**
     * Creates new form AdvHome
     */
    public AdvHome() {
        initComponents();
        setSize(814, 637);
    ...
    private void initComponents() {
        ...
        moveToInfo.setBounds(0, 10, 90, 70);
        ...
        moveToLQ.setBounds(10, 350, 380, 180);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/OPP2 interfaces.png"))); // NOI18N
    ...
    private void moveToReAndWaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveToReAndWaActionPerformed
        choose_the_type_ofquize(AdvHome.this);
...
//int choice = JOptionPane.showConfirmDialog(null, "You will be signed out and go to a worldwide competition.", "Warning", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
